          ...
          {slides.map((slide) => (
            ...
            >
              ...
              <div className="absolute inset-y-0 right-0 w-full opacity-70 sm:w-[62%] lg:w-[58%]">
                ...
                />
                <div className="absolute inset-0 bg-[linear-gradient(90deg,#050000_0%,rgba(5,0,0,0.92)_10%,rgba(5,0,0,0.28)_58%,rgba(5,0,0,0.15)_100%)]" />
              </div>
              ...
              <div className="relative mx-auto flex min-h-[590px] max-w-[1440px] items-center px-8 py-14 sm:px-16 lg:px-24">
                <div className="relative z-10 min-w-0 w-full max-w-[620px]">
                  ...
                  <h1 className="font-display mt-3 text-4xl font-extrabold leading-[0.98] text-white sm:text-5xl lg:text-6xl">
                    {slide.titulo}
