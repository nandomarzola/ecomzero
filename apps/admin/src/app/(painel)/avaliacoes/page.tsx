  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-white/45">Modere notas, comentários e fotos enviados por clientes que receberam seus pedidos.</p>
      </div>
      <section className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <OrderSummaryCard label="Rejeitadas" value={String(rejected)} subtitle="Aguardam correção" icon={XCircle} tone="purple" />
